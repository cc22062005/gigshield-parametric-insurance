...
export default function Dashboard() {
  ...
  const triggerInstantPayoutDemo = async () => {
    setNotification({
      ...
      desc: 'Validating zone data against active policy...',
      show: true,
      type: 'alert',
    });
    ...
    setTimeout(async () => {
      setNotification({
        title: 'ML Fraud Check',
        desc: 'Evaluating telemetry integrity...',
        show: true,
        type: 'alert',
      });

      try {
        await api.post('/claims/fraud-check', { claimId: 'clm_demo' });
      } catch (error) {
      }
      ...
      setTimeout(() => {
        ...
        setNotification({
          ...
          desc: '₹500 automatically credited to your wallet via UPI.',
          show: true,
          type: 'success',
        });
      ...
      <div className="p-6 lg:p-8 space-y-6 animate-fade-in relative z-0 min-h-full">
        {notification.show && (
          <div className="fixed top-24 left-1/2 -translate-x-1/2 z-50 animate-bounce-in w-full max-w-sm">
            <div
              className={`p-4 rounded-xl border shadow-2xl backdrop-blur-md ${notification.type === 'success'
            ...
            >
              {notification.type === 'success' ? (
                ...
                <Zap className="w-6 h-6 shrink-0 text-blue-400 animate-pulse" />
              )}
              <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-400 flex items-center gap-1.5 mt-1">
              ...
              Zone 4: Andheri East, Mumbai
            </p>
          </div>

          <div className="flex items-center gap-3">
            <div
              className={`flex items-center gap-2 bg-dark-800 px-4 py-2 rounded-xl border transition-all duration-500 ${notification.type === 'success'
                  ? 'border-brand-500 shadow-glow-green scale-105'
                  : 'border-dark-600'
                }`}
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <KPICard
            ...
            label="Active Policy"
            value={activePlan}
            trend={{ value: '7d left', positive: true }}
          />
          <KPICard
            icon={Wallet}
          ...
          <KPICard
            ...
            value="168h"
            trend={{ value: '24/7', positive: true }}
            iconColor="text-blue-400"
          ...
          <div className="space-y-6">
            <div className="glass-card">
              ...
              <div className="bg-brand-500/5 border border-brand-500/15 rounded-xl p-4 relative overflow-hidden">
                ...
                <p className="text-xs text-brand-300 font-semibold tracking-wider mb-1">
                  WEEKLY COVER
                </p>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-semibold">₹97/week</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Max Payout</span>
                    <span className="text-white font-semibold">₹500/day</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Valid Until</span>
                    <span className="text-slate-300">Apr 06, 11:59 PM</span>
                  </div>
                </div>
                ...
                <div className="mt-3 flex flex-wrap gap-1.5">
                  {['Rain', 'AQI'].map((t) => (
                    <span
                      key={t}
                      className="text-[10px] font-semibold px-2 py-0.5 rounded bg-brand-500/10 text-brand-400 border border-brand-500/20"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <button
                onClick={triggerInstantPayoutDemo}
                disabled={notification.show}
                className="mt-4 w-full btn-secondary text-xs flex items-center justify-center gap-2 !py-2 disabled:opacity-50"
              >
                <Zap className="w-3.5 h-3.5" />
                Simulate Instant Payout Push
              </button>
            </div>
            ...
            <div className="glass-card">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-300">82/100</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Pollution</span>
                  <span className="text-slate-300">60/100</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Disruptions</span>
                  <span className="text-slate-300">70/100</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Claim History</span>
              ...
              <div className="mt-4 flex gap-2 items-start bg-amber-500/5 p-3 rounded-xl border border-amber-500/10">
                ...
                <p className="text-xs text-amber-200/70">
                  High rain probability this week. Pro Cover recommended.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="glass-card">
              <h3 className="font-semibold text-white mb-4 flex items-center gap-2">
                ...
                <span className="text-[10px] font-medium px-2 py-0.5 rounded bg-brand-500/10 text-brand-400">
                  REAL-TIME
                </span>
              </h3>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {triggers.map((t, i) => (
                  <div
                    key={i}
                    className={`rounded-xl p-3 border ${t.active
                        ? 'border-red-500/30 bg-red-500/5'
                        : 'border-white/[0.04] bg-dark-800/40'
                      }`}
                  >
                    <div
                      className={`w-8 h-8 rounded-lg ${t.bg} flex items-center justify-center mb-2`}
                    >
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <ChartCard
                ...
                subtitle="Your zone past 30 days"
              >
